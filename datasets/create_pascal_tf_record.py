...
import dataset_util
from cls_dict_gen import gen_labels

labels = gen_labels()
######### TRAIN OR TEST SET ##########
MODE = 'test'
flags = tf.app.flags
flags.DEFINE_string('data_dir', '../data/{}/'.format(MODE), 'Root directory to raw PASCAL VOC dataset.')
flags.DEFINE_string('set', 'train', 'Convert training set, validation set or '
                                    'merged set.')
flags.DEFINE_string('annotations_dir', 'labels',
                    '(Relative) path to annotations directory.')
flags.DEFINE_string('imgs_dir', 'imgs',
                    '(Relative) path to img directory.')
flags.DEFINE_string('output_path', '../data/record/{}.record'.format(MODE), 'Path to output TFRecord')
